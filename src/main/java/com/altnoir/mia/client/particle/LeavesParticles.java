package com.altnoir.mia.client.particle;
...
public class LeavesParticles extends TextureSheetParticle {
    ...
    public LeavesParticles(ClientLevel level, double x, double y, double z, SpriteSet spriteSet) {
        super(level, x, y, z);
    ...
    public void tick() {
        ...
        if (!this.removed) {
            ...
            double d0 =
                    Math.cos(Math.toRadians(this.particleRandom * 60.0F))
                            * 2.0
                            * Math.pow(f1, 1.25);
            double d1 =
                    Math.sin(Math.toRadians(this.particleRandom * 60.0F))
                            * 2.0
                            * Math.pow(f1, 1.25);
            this.xd += d0 * 0.0025F;
            this.zd += d1 * 0.0025F;
