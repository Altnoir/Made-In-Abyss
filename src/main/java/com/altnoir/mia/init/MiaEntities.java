...
public class MiaEntities {
    public static final DeferredRegister<EntityType<?>> ENTITY_TYPES =
            DeferredRegister.create(Registries.ENTITY_TYPE, MIA.MOD_ID);
    ...
    public static final Supplier<EntityType<HookEntity>> HOOK =
            registerHook(
                    "hook",
    ...
    public static <T extends Entity> Supplier<EntityType<T>> registerHook(
