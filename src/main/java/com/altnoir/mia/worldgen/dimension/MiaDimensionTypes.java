...
public class MiaDimensionTypes {
    public static final ResourceKey<DimensionType> THE_ABYSS_TYPE =
            ResourceKey.create(Registries.DIMENSION_TYPE, MiaUtil.miaId("the_abyss_type"));
    public static final ResourceKey<DimensionType> GREAT_FAULT_TYPE =
            ResourceKey.create(Registries.DIMENSION_TYPE, MiaUtil.miaId("great_fault_type"));
