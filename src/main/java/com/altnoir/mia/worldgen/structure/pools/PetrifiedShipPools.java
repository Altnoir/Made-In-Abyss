...
public final class PetrifiedShipPools {
    public static final ResourceKey<StructureTemplatePool> MAIN =
            MiaPools.createKey("petrified_ship/main");
    public static final ResourceKey<StructureTemplatePool> BRANCH =
            MiaPools.createKey("petrified_ship/branch");
    public static final ResourceKey<StructureTemplatePool> START =
            MiaPools.createKey("petrified_ship/start");
    public static final ResourceKey<StructureTemplatePool> CONNECT_LEFT =
            MiaPools.createKey("petrified_ship/connect_left");
    public static final ResourceKey<StructureTemplatePool> CONNECT_RIGHT =
            MiaPools.createKey("petrified_ship/connect_right");
    public static final ResourceKey<StructureTemplatePool> LEFT_OR_RIGHT =
            MiaPools.createKey("petrified_ship/left_or_right");
    ...
    private static Pair<
                    ...
                    Integer>
            piece(String template, int weight) {
