...
public class MiaStructures {
    public static final ResourceKey<Structure> ANCIENT_BABYLON_COMPASS_RUINS =
            createKey("ancient_babylon_compass_ruins");
    public static final ResourceKey<Structure> ANCIENT_MAYA_COMPASS_RUINS =
            createKey("ancient_maya_compass_ruins");
    public static final ResourceKey<Structure> ANCIENT_ROMAN_COMPASS_RUINS =
            createKey("ancient_roman_compass_ruins");
    public static final ResourceKey<Structure> ANCIENT_TRIAL_COMPASS_RUINS =
            createKey("ancient_trial_compass_ruins");
    public static final ResourceKey<Structure> ANCIENT_ANGKOR_COMPASS_RUINS =
            createKey("ancient_angkor_compass_ruins");
    ...
    public static final ResourceKey<Structure> RUINED_CAVE_RAIDER_HUT =
            createKey("ruined_cave_raider_hut");
    ...
    public static void bootstrap(BootstrapContext<Structure> context) {
        ...
        registerCaveFloorStructure(
                ...
                templatePool,
                ABYSSAL_RUINS_01,
                MiaTags.Biomes.HAS_ABYSSAL_RUINS,
                AbyssSurfacePools.ABYSSAL_RUINS_01,
                9);
        registerCaveFloorStructure(
                context,
                biome,
                ...
                ABYSSAL_RUINS_02,
                MiaTags.Biomes.HAS_ABYSSAL_RUINS,
                AbyssSurfacePools.ABYSSAL_RUINS_02,
                7);
        registerCaveFloorStructure(
                context,
                biome,
                ...
                ABYSSAL_RUINS_03,
                MiaTags.Biomes.HAS_ABYSSAL_RUINS,
                AbyssSurfacePools.ABYSSAL_RUINS_03,
                9);
        registerCaveFloorStructure(
                context,
                biome,
                ...
                ABYSSAL_RUINS_04,
                MiaTags.Biomes.HAS_ABYSSAL_RUINS,
                AbyssSurfacePools.ABYSSAL_RUINS_04,
                8);
        registerCaveFloorStructure(
                context,
                biome,
                ...
                ABYSSAL_RUINS_05,
                MiaTags.Biomes.HAS_ABYSSAL_RUINS,
                AbyssSurfacePools.ABYSSAL_RUINS_05,
                9);
        registerCaveFloorStructure(
                context,
                biome,
                ...
                ABYSSAL_RUINS_06,
                MiaTags.Biomes.HAS_ABYSSAL_RUINS,
                AbyssSurfacePools.ABYSSAL_RUINS_06,
                10);
        registerCaveFloorStructure(
                context,
                biome,
                templatePool,
                CAVE_RAIDER_HUT,
                MiaTags.Biomes.HAS_CAVE_RAIDER_HUT,
                CaveRaiderHutPools.START,
                10);
        registerHeightCappedSurfaceStructure(
                ...
                MiaTags.Biomes.HAS_RUINED_CAVE_RAIDER_HUT,
                AbyssSurfacePools.RUINED_CAVE_RAIDER_HUT);
        registerHeightCappedSurfaceStructure(
                context,
                biome,
                templatePool,
                FISHERMAN_HUT,
                MiaTags.Biomes.HAS_FISHERMAN_HUT,
                AbyssSurfacePools.FISHERMAN_HUT);
        context.register(
                ...
                new JigsawStructure(
                        ...
                        1,
                        UniformHeight.of(
                                VerticalAnchor.absolute(-40), VerticalAnchor.absolute(-20)),
                        false,
                        Optional.empty(),
                        116,
                        List.of(),
        ...
        context.register(
                ...
                new MiaJigsawStructure(
                        new Structure.StructureSettings.Builder(
                                        biome.getOrThrow(MiaTags.Biomes.HAS_PETRIFIED_SHIP))
                                .generationStep(GenerationStep.Decoration.UNDERGROUND_STRUCTURES)
        ...
        context.register(
                ...
                new MiaJigsawStructure(
                        new Structure.StructureSettings.Builder(
                                        biome.getOrThrow(MiaTags.Biomes.HAS_ISLAND))
                                .generationStep(GenerationStep.Decoration.UNDERGROUND_STRUCTURES)
                                .terrainAdapation(TerrainAdjustment.ENCAPSULATE)
                                .spawnOverrides(emptySpawnOverrides())
                                .build(),
        ...
        context.register(
                ...
                new AbyssWindmillStructure(
                        new Structure.StructureSettings.Builder(
                                        biome.getOrThrow(MiaTags.Biomes.HAS_ABYSS_WINDMILL))
                                .generationStep(GenerationStep.Decoration.UNDERGROUND_STRUCTURES)
