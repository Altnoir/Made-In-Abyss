...
public class InvertedStraightTrunkPlacer extends TrunkPlacer {
    public static final MapCodec<InvertedStraightTrunkPlacer> CODEC =
            RecordCodecBuilder.mapCodec(
                    instance ->
                            trunkPlacerParts(instance)
                                    .apply(instance, InvertedStraightTrunkPlacer::new));
    ...
    public List<FoliagePlacer.FoliageAttachment> placeTrunk(
        ...
        return ImmutableList.of(
                new FoliagePlacer.FoliageAttachment(pos.below(freeTreeHeight), 0, false));
    }
}
