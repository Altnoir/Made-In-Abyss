...
public record MiaCheatLootTable(HolderLookup.Provider registries) implements LootTableSubProvider {
    public static final ResourceKey<LootTable> SIMPLE_RUINS =
            MiaLootTableProvider.register("chests/simple_ruins");
    public static final ResourceKey<LootTable> STAR_COMPASS_RUINS =
            MiaLootTableProvider.register("chests/star_compass_ruins");
    public static final ResourceKey<LootTable> STAR_COMPASS_RUINS_FINAL =
            MiaLootTableProvider.register("chests/star_compass_ruins_final");
    public static final ResourceKey<LootTable> ABYSS_STRONGHOLD_FIGHTING_ROOM =
            MiaLootTableProvider.register("chests/abyss_stronghold/fighting_room");
    public static final ResourceKey<LootTable> ABYSS_STRONGHOLD_FIGHTING_ROOM_FINAL =
            MiaLootTableProvider.register("chests/abyss_stronghold/fighting_room_final");
    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> output) {
                                ...
                                LootPool.lootPool()
                                        ...
                                        .add(
                                                LootItem.lootTableItem(Items.SKELETON_SKULL)
                                                        .setWeight(20))
                                        .add(
                                                LootItem.lootTableItem(Items.GOLDEN_HORSE_ARMOR)
                                                        .setWeight(10))
                                        .add(
                                                        ...
                                                        .apply(
                                                                SetItemCountFunction.setCount(
                                                                        UniformGenerator.between(
                                                                                2.0F, 4.0F))))));
        output.accept(
                STAR_COMPASS_RUINS_FINAL,
                LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(1.0F))
                                        .add(
                                                LootItem.lootTableItem(MiaItems.RED_WHISTLE.get())
                                                        .apply(
                                                                SetItemCountFunction.setCount(
        ...
        output.accept(
                ABYSS_STRONGHOLD_FIGHTING_ROOM,
                LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(5.0F))
                                                        ...
                                                        .apply(
                                                                SetItemCountFunction.setCount(
                                                                        UniformGenerator.between(
                                                                                2.0F, 4.0F))))));
        output.accept(
                ABYSS_STRONGHOLD_FIGHTING_ROOM_FINAL,
                LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(5.0F))
