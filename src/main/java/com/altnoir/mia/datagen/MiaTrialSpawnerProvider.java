...
public class MiaTrialSpawnerProvider extends AbyssTrialSpawnerDataProvider {
    ...
    protected void addSpawners() {
        ...
        add(
                ...
                createPattern(
                        List.of(entity(EntityType.SPIDER, 10), entity(EntityType.CAVE_SPIDER, 5)),
                        List.of(loot(BuiltInLootTables.TRIAL_CHAMBERS_REWARD_COMMON, 10)),
                        4,
                        2,
                        2,
                        6));
        ...
        add(
                ...
                createPattern(
                        List.of(entity(EntityType.WARDEN, 1)),
                        List.of(
